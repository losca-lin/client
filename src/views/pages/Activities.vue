	...
	<div class="fater-body-show">
		...
		<el-card shadow="never">
			...
			<div>
				<el-table v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading"
					...
					<el-table-column align="center" prop="teamName" label="发布小组"></el-table-column>
						...
						<template slot-scope="scope">
							<el-popover trigger="click"  :width="700" placement="left">
								...
								<el-descriptions :column="1" size="small" border>
									...
									<el-descriptions-item>
										<template slot="label">发布小组</template>
										{{ scope.row.teamName }}
									</el-descriptions-item>
									<el-descriptions-item>
		...
		<el-dialog title="添加信息" :fullscreen="true" :visible.sync="showAddFlag">
			<el-form label-width="90px" :model="activitiesForm">
				...
				<el-form-item label="发布小组">
					<el-select style="width:100%;" v-model="activitiesForm.teamId" placeholder="请选择发布小组…">
