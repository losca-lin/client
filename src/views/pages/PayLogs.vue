	...
	<div class="fater-body-show">
		...
		<el-card shadow="never">
			...
			<div>
				<el-table v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading"
					...
					<el-table-column align="center" prop="teamName" label="小组名称"></el-table-column>
		...
		<el-dialog title="添加信息" width="600px" :visible.sync="showAddFlag">
			<el-form label-width="90px" :model="payLogsForm">
				...
				<el-form-item label="收费小组">
					<el-select style="width:100%;" v-model="payLogsForm.teamId" placeholder="请输入收费小组…">
