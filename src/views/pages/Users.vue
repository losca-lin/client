    ...
    <div class="fater-body-show">
        ...
        <el-card shadow="never">
            <div>
                <el-table 
                    ...
                    <el-table-column align="center" prop="address" label="所在院系及专业"></el-table-column>
                    <el-table-column align="center" label="用户身份">
                        <template slot-scope="scope">
                            <span v-if="scope.row.type == 0">教练</span>
                            <span v-if="scope.row.type == 1">球队队长</span>
                            <span v-if="scope.row.type == 2">球队成员</span>
                        </template>
                    </el-table-column>
        ...
        <el-dialog title="修改信息" width="600px" :visible.sync="showUpdFlag">
            <el-form label-width="90px" :model="usersForm">
                ...
                <el-form-item label="所在院系及专业">
                    <el-input rows="4" type="textarea" v-model="usersForm.address"
                              placeholder="请输入所在院系及专业…" autocomplete="off"></el-input>
                </el-form-item>
            </el-form>
