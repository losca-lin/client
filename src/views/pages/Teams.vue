		...
		<el-card shadow="never">
			...
			<div>
				<el-form :inline="true" :model="qryForm">
					...
					<el-form-item >
						<el-select v-model="qryForm.typeId" placeholder="请选择球队职位">
		...
		<el-card shadow="never">
			...
			<div>
				<el-table v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading"
					...
					<el-table-column align="center" prop="name" label="小组名称"></el-table-column>
					<el-table-column align="center" prop="typeName" label="球队职位"></el-table-column>
					<el-table-column align="center" prop="managerName" label="小组组长"></el-table-column>
					<el-table-column align="center" prop="createTime" label="建立时间"></el-table-column>
					<el-table-column align="center" prop="total" label="小组人数"></el-table-column>
			...
			<el-form label-width="90px" :model="teamsForm">
				<el-form-item label="小组名称">
					<el-input v-model="teamsForm.name" 
						placeholder="请输入小组名称…" autocomplete="off"></el-input>
				</el-form-item>
				<el-form-item label="球队职位">
					<el-select style="width:100%;" v-model="teamsForm.typeId" placeholder="请选择球队职位">
						<el-option v-for="(item, index) in teamTypes" 
							:key="index" :label="item.name" :value="item.id"></el-option>
					</el-select>
				</el-form-item>
				<el-form-item label="小组组长">
					<el-input v-model="teamsForm.manager" 
						placeholder="请输入小组管理员ID…" autocomplete="off"></el-input>
				</el-form-item>
			</el-form>
