	...
	<div class="fater-body-show">
		...
		<el-card shadow="never">
			...
			<div>
				<el-table v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading"
					...
					<el-table-column align="center" prop="teamId" label="发布小组">
		...
		<el-dialog title="添加信息" width="600px" :visible.sync="showAddFlag">
			<el-form label-width="90px" :model="noticesForm">
				...
				<el-form-item v-if="userType == 1" label="发布小组">
					<el-select style="width:100%;" v-model="noticesForm.teamId" placeholder="请选择发布小组…">
