		...
		<el-card shadow="never">
			...
			<div>
				<el-form :inline="true" :model="qryForm">
					<el-form-item>
						<el-input v-model="qryForm.name" placeholder="输入球队职位名称…" autocomplete="off"></el-input>
					</el-form-item>
					<el-form-item>
		...
		<el-card shadow="never">
			...
			<div>
				<el-table v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading"
					...
					<el-table-column align="center" prop="name" label="职位名称"></el-table-column>
		...
		<el-dialog title="添加信息" width="600px" :visible.sync="showAddFlag">
			<el-form label-width="90px" :model="teamTypesForm">
				<el-form-item label="职位名称">
					<el-input v-model="teamTypesForm.name" placeholder="请输入职位名称…" autocomplete="off"></el-input>
				</el-form-item>
			</el-form>
